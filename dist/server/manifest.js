export const manifest = {
	...
	_: {
		entry: {"file":"start-76ef460d.js","js":["start-76ef460d.js","chunks/index-2253cd81.js"],"css":[]},
		nodes: [
			() => import('./nodes/0.js'),
			() => import('./nodes/1.js'),
			() => import('./nodes/3.js'),
		...
		routes: [
			...
			},
			{
				...
				names: [],
				types: [],
				load: () => import('./entries/endpoints/api/years.ts.js')
			},
			{
				type: 'endpoint',
				id: "api/infoTabla",
				...
				names: [],
				types: [],
				load: () => import('./entries/endpoints/api/infoTabla.ts.js')
			},
			{
				type: 'endpoint',
				id: "api/entries",
				...
				names: [],
				types: [],
				load: () => import('./entries/endpoints/api/entries.ts.js')
			},
			{
				type: 'endpoint',
				id: "api/countries",
				...
				names: [],
				types: [],
				load: () => import('./entries/endpoints/api/countries.ts.js')
			}
		],
		matchers: async () => {
